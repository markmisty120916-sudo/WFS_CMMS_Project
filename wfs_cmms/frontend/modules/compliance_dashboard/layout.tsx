...
export default function ComplianceDashboardLayout(props: { readonly children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    setAllowed(canAccessComplianceDashboard(session.role) && session.tenant_id !== "");
    setReady(true);
  }, []);
  ...
  return (
    <div className="min-h-screen bg-[#05010d] text-[#f5f3ff]" style={shellStyle}>
      <header style={barStyle}>
        <p style={brandStyle}>Compliance Dashboard</p>
