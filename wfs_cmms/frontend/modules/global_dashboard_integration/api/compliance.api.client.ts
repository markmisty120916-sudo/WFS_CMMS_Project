...
export async function listIntegrationCompliance(
  session: GlobalDashboardIntegrationSession | null,
  query: Readonly<Record<string, string>>,
): Promise<unknown> {
  return globalDashboardIntegrationRequest(session, GLOBAL_DASHBOARD_INTEGRATION_CLIENT_ROUTES.compliance, query);
}
