...
export const PARTS_MANAGER_PREDICTIVE_TYPES: readonly string[] = Object.freeze([
  PARTS_MANAGER_EVENT_TYPES.predictive_generated,
  PARTS_MANAGER_EVENT_TYPES.predictive_updated,
  PARTS_MANAGER_EVENT_TYPES.predictive_escalated,
]);
